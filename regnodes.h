...
#define	END_for_utf8          	1	/* 0x01  */
#define	SUCCEED_non_utf8      	2	/* 0x02  */
#define	SUCCEED_for_utf8      	3	/* 0x03  */
#define	SBOL_non_utf8         	4	/* 0x04  */
#define	SBOL_for_utf8         	5	/* 0x05  */
#define	MBOL_non_utf8         	6	/* 0x06  */
#define	MBOL_for_utf8         	7	/* 0x07  */
#define	SEOL_non_utf8         	8	/* 0x08  */
#define	SEOL_for_utf8         	9	/* 0x09  */
#define	MEOL_non_utf8         	10	/* 0x0a  */
#define	MEOL_for_utf8         	11	/* 0x0b  */
#define	EOS_non_utf8          	12	/* 0x0c  */
#define	EOS_for_utf8          	13	/* 0x0d  */
#define	GPOS_non_utf8         	14	/* 0x0e  */
#define	GPOS_for_utf8         	15	/* 0x0f  */
#define	BOUND_non_utf8        	16	/* 0x10  */
#define	BOUND_for_utf8        	17	/* 0x11  */
#define	BOUNDL_non_utf8       	18	/* 0x12  */
#define	BOUNDL_for_utf8       	19	/* 0x13  */
#define	BOUNDU_non_utf8       	20	/* 0x14  */
#define	BOUNDU_for_utf8       	21	/* 0x15  */
#define	BOUNDA_non_utf8       	22	/* 0x16  */
#define	BOUNDA_for_utf8       	23	/* 0x17  */
#define	NBOUND_non_utf8       	24	/* 0x18  */
#define	NBOUND_for_utf8       	25	/* 0x19  */
#define	NBOUNDL_non_utf8      	26	/* 0x1a  */
#define	NBOUNDL_for_utf8      	27	/* 0x1b  */
#define	NBOUNDU_non_utf8      	28	/* 0x1c  */
#define	NBOUNDU_for_utf8      	29	/* 0x1d  */
#define	NBOUNDA_non_utf8      	30	/* 0x1e  */
#define	NBOUNDA_for_utf8      	31	/* 0x1f  */
#define	REG_ANY_non_utf8      	32	/* 0x20  */
#define	REG_ANY_for_utf8      	33	/* 0x21  */
#define	SANY_non_utf8         	34	/* 0x22  */
#define	SANY_for_utf8         	35	/* 0x23  */
#define	ANYOF_non_utf8        	36	/* 0x24  */
#define	ANYOF_for_utf8        	37	/* 0x25  */
#define	ANYOFD_non_utf8       	38	/* 0x26  */
#define	ANYOFD_for_utf8       	39	/* 0x27  */
#define	ANYOFL_non_utf8       	40	/* 0x28  */
#define	ANYOFL_for_utf8       	41	/* 0x29  */
#define	ANYOFPOSIXL_non_utf8  	42	/* 0x2a  */
#define	ANYOFPOSIXL_for_utf8  	43	/* 0x2b  */
#define	ANYOFH_non_utf8       	44	/* 0x2c  */
#define	ANYOFH_for_utf8       	45	/* 0x2d  */
#define	ANYOFHb_non_utf8      	46	/* 0x2e  */
#define	ANYOFHb_for_utf8      	47	/* 0x2f  */
#define	ANYOFHr_non_utf8      	48	/* 0x30  */
#define	ANYOFHr_for_utf8      	49	/* 0x31  */
#define	ANYOFHs_non_utf8      	50	/* 0x32  */
#define	ANYOFHs_for_utf8      	51	/* 0x33  */
#define	ANYOFR_non_utf8       	52	/* 0x34  */
#define	ANYOFR_for_utf8       	53	/* 0x35  */
#define	ANYOFRb_non_utf8      	54	/* 0x36  */
#define	ANYOFRb_for_utf8      	55	/* 0x37  */
#define	ANYOFM_non_utf8       	56	/* 0x38  */
#define	ANYOFM_for_utf8       	57	/* 0x39  */
#define	NANYOFM_non_utf8      	58	/* 0x3a  */
#define	NANYOFM_for_utf8      	59	/* 0x3b  */
#define	POSIXD_non_utf8       	60	/* 0x3c  */
#define	POSIXD_for_utf8       	61	/* 0x3d  */
#define	POSIXL_non_utf8       	62	/* 0x3e  */
#define	POSIXL_for_utf8       	63	/* 0x3f  */
#define	POSIXU_non_utf8       	64	/* 0x40  */
#define	POSIXU_for_utf8       	65	/* 0x41  */
#define	POSIXA_non_utf8       	66	/* 0x42  */
#define	POSIXA_for_utf8       	67	/* 0x43  */
#define	NPOSIXD_non_utf8      	68	/* 0x44  */
#define	NPOSIXD_for_utf8      	69	/* 0x45  */
#define	NPOSIXL_non_utf8      	70	/* 0x46  */
#define	NPOSIXL_for_utf8      	71	/* 0x47  */
#define	NPOSIXU_non_utf8      	72	/* 0x48  */
#define	NPOSIXU_for_utf8      	73	/* 0x49  */
#define	NPOSIXA_non_utf8      	74	/* 0x4a  */
#define	NPOSIXA_for_utf8      	75	/* 0x4b  */
#define	CLUMP_non_utf8        	76	/* 0x4c  */
#define	CLUMP_for_utf8        	77	/* 0x4d  */
#define	BRANCH_non_utf8       	78	/* 0x4e  */
#define	BRANCH_for_utf8       	79	/* 0x4f  */
#define	EXACT_non_utf8        	80	/* 0x50  */
#define	EXACT_for_utf8        	81	/* 0x51  */
#define	LEXACT_non_utf8       	82	/* 0x52  */
#define	LEXACT_for_utf8       	83	/* 0x53  */
#define	EXACTL_non_utf8       	84	/* 0x54  */
#define	EXACTL_for_utf8       	85	/* 0x55  */
#define	EXACTF_non_utf8       	86	/* 0x56  */
#define	EXACTF_for_utf8       	87	/* 0x57  */
#define	EXACTFL_non_utf8      	88	/* 0x58  */
#define	EXACTFL_for_utf8      	89	/* 0x59  */
#define	EXACTFU_non_utf8      	90	/* 0x5a  */
#define	EXACTFU_for_utf8      	91	/* 0x5b  */
#define	EXACTFAA_non_utf8     	92	/* 0x5c  */
#define	EXACTFAA_for_utf8     	93	/* 0x5d  */
#define	EXACTFUP_non_utf8     	94	/* 0x5e  */
#define	EXACTFUP_for_utf8     	95	/* 0x5f  */
#define	EXACTFLU8_non_utf8    	96	/* 0x60  */
#define	EXACTFLU8_for_utf8    	97	/* 0x61  */
#define	EXACTFAA_NO_TRIE_non_utf8	98	/* 0x62  */
#define	EXACTFAA_NO_TRIE_for_utf8	99	/* 0x63  */
#define	EXACT_REQ8_non_utf8   	100	/* 0x64  */
#define	EXACT_REQ8_for_utf8   	101	/* 0x65  */
#define	LEXACT_REQ8_non_utf8  	102	/* 0x66  */
#define	LEXACT_REQ8_for_utf8  	103	/* 0x67  */
#define	EXACTFU_REQ8_non_utf8 	104	/* 0x68  */
#define	EXACTFU_REQ8_for_utf8 	105	/* 0x69  */
#define	EXACTFU_S_EDGE_non_utf8	106	/* 0x6a  */
#define	EXACTFU_S_EDGE_for_utf8	107	/* 0x6b  */
#define	NOTHING_non_utf8      	108	/* 0x6c  */
#define	NOTHING_for_utf8      	109	/* 0x6d  */
#define	TAIL_non_utf8         	110	/* 0x6e  */
#define	TAIL_for_utf8         	111	/* 0x6f  */
#define	STAR_non_utf8         	112	/* 0x70  */
#define	STAR_for_utf8         	113	/* 0x71  */
#define	PLUS_non_utf8         	114	/* 0x72  */
#define	PLUS_for_utf8         	115	/* 0x73  */
#define	CURLY_non_utf8        	116	/* 0x74  */
#define	CURLY_for_utf8        	117	/* 0x75  */
#define	CURLYN_non_utf8       	118	/* 0x76  */
#define	CURLYN_for_utf8       	119	/* 0x77  */
#define	CURLYM_non_utf8       	120	/* 0x78  */
#define	CURLYM_for_utf8       	121	/* 0x79  */
#define	CURLYX_non_utf8       	122	/* 0x7a  */
#define	CURLYX_for_utf8       	123	/* 0x7b  */
#define	WHILEM_non_utf8       	124	/* 0x7c  */
#define	WHILEM_for_utf8       	125	/* 0x7d  */
#define	OPEN_non_utf8         	126	/* 0x7e  */
#define	OPEN_for_utf8         	127	/* 0x7f  */
#define	CLOSE_non_utf8        	128	/* 0x80  */
#define	CLOSE_for_utf8        	129	/* 0x81  */
#define	SROPEN_non_utf8       	130	/* 0x82  */
#define	SROPEN_for_utf8       	131	/* 0x83  */
#define	SRCLOSE_non_utf8      	132	/* 0x84  */
#define	SRCLOSE_for_utf8      	133	/* 0x85  */
#define	REF_non_utf8          	134	/* 0x86  */
#define	REF_for_utf8          	135	/* 0x87  */
#define	REFF_non_utf8         	136	/* 0x88  */
#define	REFF_for_utf8         	137	/* 0x89  */
#define	REFFL_non_utf8        	138	/* 0x8a  */
#define	REFFL_for_utf8        	139	/* 0x8b  */
#define	REFFU_non_utf8        	140	/* 0x8c  */
#define	REFFU_for_utf8        	141	/* 0x8d  */
#define	REFFA_non_utf8        	142	/* 0x8e  */
#define	REFFA_for_utf8        	143	/* 0x8f  */
#define	REFN_non_utf8         	144	/* 0x90  */
#define	REFN_for_utf8         	145	/* 0x91  */
#define	REFFN_non_utf8        	146	/* 0x92  */
#define	REFFN_for_utf8        	147	/* 0x93  */
#define	REFFLN_non_utf8       	148	/* 0x94  */
#define	REFFLN_for_utf8       	149	/* 0x95  */
#define	REFFUN_non_utf8       	150	/* 0x96  */
#define	REFFUN_for_utf8       	151	/* 0x97  */
#define	REFFAN_non_utf8       	152	/* 0x98  */
#define	REFFAN_for_utf8       	153	/* 0x99  */
#define	LONGJMP_non_utf8      	154	/* 0x9a  */
#define	LONGJMP_for_utf8      	155	/* 0x9b  */
#define	BRANCHJ_non_utf8      	156	/* 0x9c  */
#define	BRANCHJ_for_utf8      	157	/* 0x9d  */
#define	IFMATCH_non_utf8      	158	/* 0x9e  */
#define	IFMATCH_for_utf8      	159	/* 0x9f  */
#define	UNLESSM_non_utf8      	160	/* 0xa0  */
#define	UNLESSM_for_utf8      	161	/* 0xa1  */
#define	SUSPEND_non_utf8      	162	/* 0xa2  */
#define	SUSPEND_for_utf8      	163	/* 0xa3  */
#define	IFTHEN_non_utf8       	164	/* 0xa4  */
#define	IFTHEN_for_utf8       	165	/* 0xa5  */
#define	GROUPP_non_utf8       	166	/* 0xa6  */
#define	GROUPP_for_utf8       	167	/* 0xa7  */
#define	EVAL_non_utf8         	168	/* 0xa8  */
#define	EVAL_for_utf8         	169	/* 0xa9  */
#define	MINMOD_non_utf8       	170	/* 0xaa  */
#define	MINMOD_for_utf8       	171	/* 0xab  */
#define	LOGICAL_non_utf8      	172	/* 0xac  */
#define	LOGICAL_for_utf8      	173	/* 0xad  */
#define	RENUM_non_utf8        	174	/* 0xae  */
#define	RENUM_for_utf8        	175	/* 0xaf  */
#define	TRIE_non_utf8         	176	/* 0xb0  */
#define	TRIE_for_utf8         	177	/* 0xb1  */
#define	TRIEC_non_utf8        	178	/* 0xb2  */
#define	TRIEC_for_utf8        	179	/* 0xb3  */
#define	AHOCORASICK_non_utf8  	180	/* 0xb4  */
#define	AHOCORASICK_for_utf8  	181	/* 0xb5  */
#define	AHOCORASICKC_non_utf8 	182	/* 0xb6  */
#define	AHOCORASICKC_for_utf8 	183	/* 0xb7  */
#define	GOSUB_non_utf8        	184	/* 0xb8  */
#define	GOSUB_for_utf8        	185	/* 0xb9  */
#define	GROUPPN_non_utf8      	186	/* 0xba  */
#define	GROUPPN_for_utf8      	187	/* 0xbb  */
#define	INSUBP_non_utf8       	188	/* 0xbc  */
#define	INSUBP_for_utf8       	189	/* 0xbd  */
#define	DEFINEP_non_utf8      	190	/* 0xbe  */
#define	DEFINEP_for_utf8      	191	/* 0xbf  */
#define	ENDLIKE_non_utf8      	192	/* 0xc0  */
#define	ENDLIKE_for_utf8      	193	/* 0xc1  */
#define	OPFAIL_non_utf8       	194	/* 0xc2  */
#define	OPFAIL_for_utf8       	195	/* 0xc3  */
#define	ACCEPT_non_utf8       	196	/* 0xc4  */
#define	ACCEPT_for_utf8       	197	/* 0xc5  */
#define	VERB_non_utf8         	198	/* 0xc6  */
#define	VERB_for_utf8         	199	/* 0xc7  */
#define	PRUNE_non_utf8        	200	/* 0xc8  */
#define	PRUNE_for_utf8        	201	/* 0xc9  */
#define	MARKPOINT_non_utf8    	202	/* 0xca  */
#define	MARKPOINT_for_utf8    	203	/* 0xcb  */
#define	SKIP_non_utf8         	204	/* 0xcc  */
#define	SKIP_for_utf8         	205	/* 0xcd  */
#define	COMMIT_non_utf8       	206	/* 0xce  */
#define	COMMIT_for_utf8       	207	/* 0xcf  */
#define	CUTGROUP_non_utf8     	208	/* 0xd0  */
#define	CUTGROUP_for_utf8     	209	/* 0xd1  */
#define	KEEPS_non_utf8        	210	/* 0xd2  */
#define	KEEPS_for_utf8        	211	/* 0xd3  */
#define	LNBREAK_non_utf8      	212	/* 0xd4  */
#define	LNBREAK_for_utf8      	213	/* 0xd5  */
#define	OPTIMIZED_non_utf8    	214	/* 0xd6  */
#define	OPTIMIZED_for_utf8    	215	/* 0xd7  */
#define	PSEUDO_non_utf8       	216	/* 0xd8  */
#define	PSEUDO_for_utf8       	217	/* 0xd9  */
#define	REGEX_SET_non_utf8    	218	/* 0xda  */
#define	REGEX_SET_for_utf8    	219	/* 0xdb  */
	/* ------------ States ------------- */
